        ...
        '>
          ...
          <div className='flex flex-1 flex-col gap-3 p-5'>
            ...
            <p className='text-sm leading-6 text-slate-400'>
              Comece <button className='text-lime-400 font-medium hover:underline'>gravando uma nota</button> em áudio ou se preferir <button onClick={setShouldShowOnboarnig} className='text-lime-400 font-medium hover:underline'>utilize apenas texto.</button>
            </p>
          </div>
